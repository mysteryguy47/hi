...
def render_vertical_question_compact(canvas, question, x: float, y: float, width: float, question_num: int, with_answers: bool = False) -> float:
            ...
            if is_vertical_block:
                ...
                for row_index, (row_questions, row_height) in enumerate(questions_by_row):
                    for col, (q, q_height, q_num) in enumerate(row_questions):
                        ...
                        render_vertical_question_compact(c, q, q_x, current_y - q_y_offset, q_width, q_num, with_answers)
